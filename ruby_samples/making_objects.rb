...
# now we can ask our WobblyPlayer class to give us a new object to represent 
# our player

p1 = WobblyPlayer.new

# the next few lines keep track of information about the player
# (we call each distinct piece of information an "attribute")
...
p1.loc_y = 1       #    tell us where in the current
...
# go look in the wobbly_player.rb file to see how it works
